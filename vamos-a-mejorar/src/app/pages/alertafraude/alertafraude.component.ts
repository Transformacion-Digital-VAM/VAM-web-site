...
@Component({
  ...
  standalone: false,
  templateUrl: './alertafraude.component.html',
...
export class AlertafraudeComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (!isPlatformBrowser(this.platformId)) {
      return; // Evita ejecutar en el servidor
    }
    ...
    try {
        ...
        Swal.fire({
          ...
          html: `
            <div style="text-align: center; max-width: 750px; margin: 0 auto;">
              ...
              <div style="background-color: #91F075; border-left: 4px solid #2196f3; padding: 15px; margin: 25px 0; border-radius: 0 8px 8px 0;">
      ...
      console.error('Error con localStorage o SweetAlert:', error);
    }
  }
}
